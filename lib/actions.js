 ...
 * @param {Object} light The light to get the state for
 * @return {Promise} The Light with the refreshed state
 */
function getCurrentState(light) {
  return request({ method: 'GET', uri: light.url })
}

/**
 * Update the state of a light
 * @param {Object} light The Light to update
 * @param {Object} state The new state
 * @return {Promise}
 */
function updateState(light, state) {
  return request({ method: 'PUT', uri: `${light.url}/state`, json: state })
}
